...
## Total Sample 
```{r, echo=FALSE}
Data <- read_csv("C:/Users/andre/OneDrive/Documents/Documents/PhD Degree/Projects/Comparing Frailty Tools/Frailty_Tools_Sept10_FRAILSCALE.csv")
datatable(Data)
```
...
Data$EDUCATION [is.na(Data$EDUCATION)] <- "Missing"
Data$FRAIL_Scale [(Data$FRAIL_Scale)== 4] <- 3 # There was only
